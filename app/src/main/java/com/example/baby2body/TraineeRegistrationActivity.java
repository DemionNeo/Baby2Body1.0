...
public class TraineeRegistrationActivity extends AppCompatActivity {
    ...
    private Spinner trimestersSpinner;

    private Button registerButton;

    private Uri resultUri;
//Show progress of the user
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trimestersSpinner = findViewById(R.id.trimestersSpinner);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String trimesters = trimestersSpinner.getSelectedItem().toString();
                //To check whether the edittexts are fully filled
                ...
                if (trimesters.equals("Select your Trimester")){
                ...
                //Register User and save data to firebase
                        ...
                        //Check if user has been registered sucessfully
                        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                //Register user in the node user
                                else {
                                    String currentUserId = mAuth.getCurrentUser().getUid();
                                    userDatabaseRef = FirebaseDatabase.getInstance().getReference().child("users").child(currentUserId);
                                    //Datastructure using key value pairs to store data
                                    ...
                                    userInfo.put("search", "trainee"+trimesters);
...
//                                            loader.dismiss();
    ...
    // Makes it possible for data to be displayed on users profile
    @Override
